      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200/80 shadow-sm shadow-slate-200/50 hover:shadow-md transition-all duration-200 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          {latestRecord ? (
            ...
            <div className="space-y-1">
              ...
              <h1 className="text-2xl font-extrabold text-slate-900">Welcome to Startup Analyzer! 👋</h1>
              <p className="text-xs text-slate-500">Analyze your first startup concept to unlock your command center.</p>
            </div>
          )}
        ...
        {latestRecord && latestResult ? (
          ...
          <div className="bg-white rounded-2xl p-8 border border-slate-200/80 shadow-sm text-center space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900">No Active Startup Context</h3>
            <p className="text-xs text-slate-500">Run a startup analysis to populate your command center dashboard metrics.</p>
